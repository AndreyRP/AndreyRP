...
<body>
    ...
    <main class="">
        <form action="" method="post" enctype=multipart/form-data class="formulario">
            ...
            <input class="input" name="complemento" id="complemento" type="text">
...
// variaveis magicas                    NECESSITA BANCO
    ...
    (nome_usuario, data_nasc, email_usuario, cpf_usuario, rg_usuario, telefone_usuario, cep_usuario,
    rua_usuario, bairro_usuario, numero_casa_usuario, complemento, senha_usuario, fk_cidade) 
    VALUES 
    (:nome_usuario, :data_nasc, :email_usuario, :cpf_usuario, :rg_usuario, :telefone_usuario, :cep_usuario,
    :rua_usuario, :bairro_usuario, :numero_casa_usuario, :complemento, :senha_usuario, :cidade) ";
